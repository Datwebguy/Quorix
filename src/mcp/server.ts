  ...
  private wrapMeteredDelegate(
    ...
    return buildAgentSuccess(tool, {
      ...
      billing: {
        ...
        settlementVerified: verification?.settlementVerified ?? false,
        settlementVerification: verification?.settlementVerification ?? 'none',
        billingTier: verification?.billingTier ?? readiness.tier,
        externallyBillable: verification?.externallyBillable ?? false,
